...
?> 如果你有任何问题和改进，欢迎向我们提交 issues 和 pr.
...
不用担心环境配置困难，我们已经为你在 [实验环境](/lv0-env-config/docker) 中已经预装好并配置了 CMake 和 Bear 等必要工具.
...
如果你想知道更加详细的用法, 你可以查阅 [`clangd` 官方文档](https://clangd.llvm.org/) 以及 [`clang-format` 官方文档](https://clang.llvm.org/docs/ClangFormat.html)。
